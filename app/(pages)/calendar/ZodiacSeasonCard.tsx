...
export default function ZodiacSeasonCard() {
  ...
  return (
    <div className="@container" style={{ ["--star-sign-colour" as any]: zodiacColour }}>
      <div className="relative grid h-full grid-rows-[auto_1fr] gap-y-1 rounded-xs border-4 border-[rgb(var(--star-sign-colour)/.75)] bg-[rgb(var(--star-sign-colour)/.3)] bg-[repeating-linear-gradient(135deg,transparent,transparent_12px,rgb(var(--star-sign-colour)/.1)_12px,rgb(var(--star-sign-colour)/.1)_24px)] px-3.5 pt-1 pb-1.5 text-center font-[750] tracking-tight @[200px]:aspect-65/24 @[200px]:h-auto @[200px]:px-4">
